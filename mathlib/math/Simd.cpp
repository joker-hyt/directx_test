...
H3DSIMDProcessor *	generic1 = (H3DSIMDProcessor *)0;				// pointer to generic SIMD implementation
...
void H3DSIMD::Init( void ) {
	...
	generic1 = new H3DSIMD_Generic;
	generic1->cpuid = CPUID_GENERIC;
	processor = (H3DSIMDProcessor*)0;
	SIMDProcessor = generic1;
...
void H3DSIMD::Shutdown( void ) {
	if ( processor != generic1 ) {
		delete processor;
	}
	delete generic1;
	generic1 = (H3DSIMDProcessor*)0;
	processor = (H3DSIMDProcessor*)0;
