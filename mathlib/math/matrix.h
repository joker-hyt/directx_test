...
public:
	...
	{
		const static H3DMat4 mat4_identity( H3DVec4( 1, 0, 0, 0 ), H3DVec4( 0, 1, 0, 0 ), H3DVec4( 0, 0, 1, 0 ), H3DVec4( 0, 0, 0, 1 ) );
		return mat4_identity;
	}

	static const H3DMat4& GetZero(void)
	{
		const static H3DMat4 mat4_zero( H3DVec4( 0, 0, 0, 0 ), H3DVec4( 0, 0, 0, 0 ), H3DVec4( 0, 0, 0, 0 ), H3DVec4( 0, 0, 0, 0 ) );
		return mat4_zero;
	}
